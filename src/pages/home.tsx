        ...
        <div className="max-w-3xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left max-w-4xl mx-auto">
            <div className="bg-white p-5 rounded-lg shadow-md">
              ...
              <p>
                Adjust the number of rows and columns to make the puzzle as
            ...
            <div className="bg-white p-5 rounded-lg shadow-md">
              ...
              <p>
                ...
                against yourself or check the leaderboard to see top players.
              </p>
            </div>
            ...
            <div className="bg-white p-5 rounded-lg shadow-md">
              ...
              <p>
                ...
                a personalized puzzle experience.
              </p>
            </div>
          </div>
